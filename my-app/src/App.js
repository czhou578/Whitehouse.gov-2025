                  ...
                  <div className="econ-panel">
                    <div id="panel-1" className="econ-panel-detail">
                      <div className="econ-descript">
                        ...
                        <p>
                          We have set up a People's Bank, in order to make money
                          more accessible for others. This allows for <br></br>
                          easy transfer of money through federal stimulus, and
                          makes sure that even in impoverished areas, money{" "}
                          <br></br>
                    ...
                    <div id="panel-2" className="econ-panel-detail" hidden>
                      <div className="econ-descript">
                        ...
                        <p>
                          Automation is a new challenge that is facing America.
                          It will unleash a wave of displacement that has been
                          unseen for hundreds of years. The administration is
                          actively finding ways to support workers that would
                          otherwise suffer during this massive increase in
                          productivity. We need to reap the rewards of our
                          progress.
                        </p>
                      </div>
                    </div>
                    <div id="panel-3" className="econ-panel-detail" hidden>
                      <div className="econ-descript">
                        <p>
                          Economic statistics are inportant for this
                          administration's policies. We are actively cooperating
                          with the Bureau of Labor Statistics to put together a
                          weekly report of this country's economic state. This
                    ...
                    <div id="panel-4" className="econ-panel-detail" hidden>
                      <div className="econ-descript">
                        ...
                        <p>
                          Cryptocurrencies have become more ubiquitous in our
                          society, which ends up posing its own unique
                          challenges. Look at how we are utilizing blockchain
                          across this country to speed up transactions and
                          applications, while carefully monitoring the crypto
                          space for any violations and theft.
                        </p>
                      </div>
                    </div>
                  </div>
                  <h5 className="econ-topics">People's Bank</h5> <br></br>
                  <h5 className="econ-topics">Automation Progress </h5>{" "}
                  <br></br>
                  <h5 className="econ-topics">Important Statistics</h5>{" "}
                  <br></br>
            ...
            <section className="healthcare" id="healthcare">
              ...
              <div id="three-column">
                <Grid centered columns={3}>
                  <Grid.Column>
                    <Segment>
                      Eight years ago, I had just sold my education company and
                      married my wife, Evelyn. The country was struggling
                      through the aftermath of the financial crisis, so I made
                      it my mission to bring jobs back to the communities that
                      were hit hardest. I saw firsthand how many of our children
                      didn’t see economic opportunity at home and were moving
                      away to the same cities. That’s why I founded Venture for
                      America (VFA), an organization dedicated to rejuvenating
                      local economies. By helping entrepreneurs create jobs in
                      cities like Baltimore, Detroit, Pittsburgh, and Cleveland,
                      we could create strong economies throughout the country
                      and give children a reason to stay. In its first year, VFA
                      trained 40 Fellows; by 2017, more than 500 VFA Fellows and
                      alumni had launched dozens of companies and helped create
                      thousands of jobs across the country. The Obama White
                      House even named me a Champion of Change in 2012 and a
                      Presidential Ambassador for Global Entrepreneurship in
                      2015. Despite the success I saw with VFA, as I worked in
                      these cities, I came to a terrible realization: automation
                      is destroying jobs, and entire regions are being left
                      behind. For years, I believed new business formation was
                      the answer—if we could train a new generation of
                      entrepreneurs and create the right jobs in the right
                      places, we could stop the downward spiral of growing
                      income inequality, poverty, unemployment, and
                      hopelessness.
